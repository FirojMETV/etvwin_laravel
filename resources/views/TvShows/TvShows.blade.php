                    ...
                    <div class="details-container">
                        ...
                        <div class="ng-scope">
                            <div class="title-holder">
                                <h1 class="ng-binding title-font-size">Dear Megha
                            ...
                            <div class="viewersnav">
                                <ul class="viewerslinks">
                                    <li class="comment_padding">
                                        <label class="switch" role="button" tabindex="0" onclick="toggleLike(this, 'You liked this!', 'You unliked this!', 'thumbs-up')">
                                            <input type="checkbox" class="like-checkbox" style="display: none;">
                                            <em class="fa fa-thumbs-up" style="font-size: 25px; color: lightblue;" aria-hidden="true"></em>
                                            <span class="like-count ng-binding ng-hide" aria-hidden="true">0</span>
                                          </label>
                                    </li>
                                        ...
                                        <div class="dropdown-menu  " style="background-color: #2f357e;">
                                            <ul class="ng-social" ng-transclude="">
                                                ...
                                                <li class="ng-social-facebook ng-scope" data-toggle="tooltip"
                                                    title="Facebook" role="button" tabindex="0"><a target="_blank"
                                                ...
                                                <li class="ng-social-twitter ng-scope" data-toggle="tooltip"
                                    ...
                                    <li class="follow-item li-item">
                                        {{-- <span onclick="toggleFollow(this)" class="float-left">Follow</span> --}}
                                        <label class="switch" role="button" tabindex="0">
                                            <input type="checkbox" class="like-checkbox" style="display: none;">
                                            <div class="slider round"></div>
                                            <span onclick="toggleFollow(this)" class="follow-text">Follow</span>
                                            <span class="like-count ng-binding ng-hide" aria-hidden="true">0</span>
                                          </label>
                                    ...
                                    <li class="comment_padding">
                                                ...
                                                <label class="switch" role="button" tabindex="0" >
                                                    <input type="checkbox" class="like-checkbox" style="display: none;">
                                                    <em class="fa fa-clock-o" style="font-size: 25px; color: lightblue;" aria-hidden="true"></em>
                                                    <span class="like-count ng-binding ng-hide" aria-hidden="true">0</span>
                                                  </label>
                                    </li>
                                </ul>
...
@endsection
<script src="{{ asset('js/TvShows.js') }}"></script>
