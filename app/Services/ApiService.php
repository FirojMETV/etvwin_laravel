...
class ApiService
{
    ...
    public function apitesting($data)
    {
      ...
      //  $this->webservice = $data_config->data->service->webservice;
       ...
       $config_data = $this->BASE_URL . $this->config . "?region=" . $this->country_code2 . 
       "&auth_token=" . $this->AUTHTOKEN . "&access_token=" . $this->ACCESSTOKEN;
       $Top_Menu_api = $this->BASE_URL . "catalog_lists/top-menu-web.gzip?nested_list_items=" 
       . $this->List_false . "&auth_token=" . $this->AUTHTOKEN . "&region=" . $this->country_code2 . "&access_token=" . $this->ACCESSTOKEN;
...
//     $HomeApi = $this->BASE_URL . "catalog_lists/home.gzip?item_language=".  "eng&region=" . "IN&auth_token=" .  $this->AUTHTOKEN ."&access_token=" . $this->ACCESSTOKEN . '&page=0' .'&page_size=5' . '&npage_size=10' ;
...
//     // $catalog_list_itmes0 = $Home_data_items->data->catalog_list_items[0]->catalog_list_items[0]->thumbnails->web_banner->url;
//     $web_banner_url =[];
...
//     }}
    ...
    {
        // $response = Http::get($this->apiBaseUrl . $endpoint, array_merge($params, ['api_key' => $this->apiKey]));
